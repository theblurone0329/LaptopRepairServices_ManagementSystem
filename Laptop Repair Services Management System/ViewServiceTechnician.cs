    ...
    public partial class ViewServiceTechnician : Form
    {
        ...
        public ViewServiceTechnician()
        {
            ...
            else if (urgCount == 3 && count > 1)
            {
                ...
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName4}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
            ...
            else if (urgCount == 2 && count >= 2)
            {
                ...
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName3}' and servType = 'Normal';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;

                SqlCommand cmd4 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servName != '{servName3}' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' and servName != '{servName3}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
            ...
            else if (urgCount == 1 && count >= 3)
            {
                ...
                SqlCommand cmd2 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servType = 'Normal';", con);
                string servName2 = cmd2.ExecuteScalar().ToString();
                SqlCommand cmd6 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' and servName = '{servName2}' and servType = 'Normal';", con);
                int servProg2 = Convert.ToInt32(cmd6.ExecuteScalar().ToString());
                progressBar6.Value = servProg2 * 20;
                gbServ2.Text = servName2;

                SqlCommand cmd3 = new SqlCommand($"Select Top(2) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName2}' and servType = 'Normal';", con);
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(2) Max(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName3}' and servName != '{servName2}' and servType = 'Normal';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;

                SqlCommand cmd4 = new SqlCommand($"Select Top(3) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName3}' and servName != '{servName2}' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(3) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName4}' and servName != '{servName3}' and servName != '{servName2}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
            ...
            else if (urgCount == 3 && count >= 1)
            {
                ...
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(3) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName3}' and servName != '{servName1}' and servName != '{servName2}' and servType = 'Urgent';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;
            ...
            else if (urgCount == 2 && count >= 2)
            {
                ...
                SqlCommand cmd4 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servName != '{servName3}' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName4}' and servName != '{servName3}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
            ...
            else if (urgCount == 1 && count >= 3)
            {
                ...
                SqlCommand cmd4 = new SqlCommand($"Select Top(3) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName2}' and servName != '{servName3}' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(3) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName4}' and servName != '{servName3}' and servName != '{servName2}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
            ...
            {
                SqlCommand cmd1 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servType = 'Normal';", con);
                string servName1 = cmd1.ExecuteScalar().ToString();
                SqlCommand cmd5 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName1}' and servType = 'Normal';", con);
                int servProg = Convert.ToInt32(cmd5.ExecuteScalar().ToString());
                progressBar5.Value = servProg * 20;
                gbServ1.Text = servName1;

                SqlCommand cmd2 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servType = 'Normal';", con);
                string servName2 = cmd2.ExecuteScalar().ToString();
                SqlCommand cmd6 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName2}' and servName != '{servName1}' and servType = 'Normal';", con);
                int servProg2 = Convert.ToInt32(cmd6.ExecuteScalar().ToString());
                progressBar6.Value = servProg2 * 20;
                gbServ2.Text = servName2;

                SqlCommand cmd3 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}'and servName != '{servName2}' and servType = 'Normal';", con);
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName3}' and servName != '{servName1}'and servName != '{servName2}' and servType = 'Normal';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;

                SqlCommand cmd4 = new SqlCommand($"Select Top(4) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(4) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName4}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
            ...
            else if (count == 4)
            {
                ...
                SqlCommand cmd2 = new SqlCommand($"Select Top(2) Max(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servType = 'Normal';", con);
                string servName2 = cmd2.ExecuteScalar().ToString();
                SqlCommand cmd6 = new SqlCommand($"Select Top(2) Max(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName2}' and servName != '{servName1}' and servType = 'Normal';", con);
                int servProg2 = Convert.ToInt32(cmd6.ExecuteScalar().ToString());
                progressBar6.Value = servProg2 * 20;
                gbServ2.Text = servName2;

                SqlCommand cmd3 = new SqlCommand($"Select Top(3) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servName != '{servName2}' and servType = 'Normal';", con);
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(3) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servName != '{servName2}' and servName = '{servName3}' and servType = 'Normal';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;

                SqlCommand cmd4 = new SqlCommand($"Select Top(4) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servName != '{servName2}' and servName != '{servName3}' and servType = 'Normal';", con);
                string servName4 = cmd4.ExecuteScalar().ToString();
                SqlCommand cmd8 = new SqlCommand($"Select Top(4) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' AND servName = '{servName4}' and servName != '{servName1}' and servName != '{servName2}' and servName != '{servName3}' and servType = 'Normal';", con);
                int servProg4 = Convert.ToInt32(cmd8.ExecuteScalar().ToString());
                progressBar7.Value = servProg4 * 20;
                gbServ4.Text = servName4;
             ...
             else if (count == 3)
            {
                ...
                SqlCommand cmd2 = new SqlCommand($"Select Top(2) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servType = 'Normal';", con);
                string servName2 = cmd2.ExecuteScalar().ToString();
                SqlCommand cmd6 = new SqlCommand($"Select Top(2) Max(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName = '{servName2}' and servName != '{servName1}' and servType = 'Normal';", con);
                int servProg2 = Convert.ToInt32(cmd6.ExecuteScalar().ToString());
                progressBar6.Value = servProg2 * 20;
                ...
                SqlCommand cmd3 = new SqlCommand($"Select Top(3) Min(servName) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servName != '{servName2}' and servType = 'Normal';", con);
                string servName3 = cmd3.ExecuteScalar().ToString();
                SqlCommand cmd7 = new SqlCommand($"Select Top(3) Min(servProgress) From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servName != '{servName2}' and servType = 'Normal';", con);
                int servProg3 = Convert.ToInt32(cmd7.ExecuteScalar().ToString());
                progressBar8.Value = servProg3 * 20;
                gbServ3.Text = servName3;
            ...
            } else if (count == 2) 
            {
                ...
                SqlCommand cmd2 = new SqlCommand($"Select Top(1) servName From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servType = 'Normal';", con);
                string servName2 = cmd2.ExecuteScalar().ToString();
                SqlCommand cmd6 = new SqlCommand($"Select Top(1) servProgress From BookedServices Where servStatus = 'Service Approved' and servName != '{servName1}' and servType = 'Normal';", con);
                int servProg2 = Convert.ToInt32(cmd6.ExecuteScalar().ToString());
                progressBar6.Value = servProg2 * 20;
                gbServ2.Text = servName2;
